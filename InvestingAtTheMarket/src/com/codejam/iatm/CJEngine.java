...
public class CJEngine {
	...
	public static void main(String[] args) {
    	...
    	smallInputFile = new File("B-small-practice.in.txt");
    	smallOutputFile = new File("B-small-practice.out.txt");
		largeInputFile = new File("B-large-practice.in.txt");
		largeOutputFile = new File("B-large-practice.out.txt");
